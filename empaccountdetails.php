...
<div class="sidenav">
    ...
    <a class="active" style="text-decoration: none; font-size: 22px;" href="empaccountdetails.php">ACCOUNT DETAILS</a><br>
    <h3>EXIT</h3>
...
include("database.php");
    ...
    $ret = "SELECT * FROM empregister WHERE ename=?";
...
<td style="height:150px; color: black; background-color:lightgrey; font-size: 28px;"><?php echo $row->empid;?></td>
...
<td style="height:150px; color: black; background-color:lightgrey;"><button style="width: 80px;"><a style="font-size: 28px; text-decoration: none;" href="empeditregister.php?empid=<?php echo $row->empid;?>"><big>Edit</big></a></button></td>
<td style="height:150px; color: black; background-color:lightgrey;"><button style="width: 120px;"><a style="font-size: 28px; text-decoration: none;" href="empdeleteaccount.php?empid=<?php echo $row->empid;?>"><big>Delete</big></a></button></td>
</tr>
<?php } ?>
</table>
</div>
