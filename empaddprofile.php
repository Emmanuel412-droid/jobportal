...
if(ISSET($_POST['add'])){
        ...
        $sql="INSERT INTO empprofile(ename,phonenumber,email,county,town,yor,postal,zip) VALUES('$ename','$phonenumber','$email','$county','$town','$yor','$postal','$zip')" or die(mysqli_error());
        ...
        if($result){
            ...
            if(mail($email, $subject, $message, $sender)){
                ...
                echo("<script language='javascript'>window.alert('Profile added successful!');window.location='emplogin.php';</script>");
...
<div class="section">
        <form method="POST" action="empaddprofile.php" id="profile" name="profile" onsubmit="return validateForm()">
        <fieldset style="width:900px; background-color:floralwhite;">
            ...
            <input style="height:50px; width:300px; border: 1px hidden; background-color: black; color: floralwhite; font-size: 26px;" id="add" type="submit"  name="add" value="ADD PROFILE" onclick="validateForm()"><br><br>
