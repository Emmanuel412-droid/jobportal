...
<div class="sidenav">
    ...
    <a class="active" style="text-decoration: none; font-size: 22px;" href="empapplications.php">APPLICATIONS</a><br>
...
<td><b>School</b></td>
<td style="width:800px;"><b>Skills</b></td>
...
?>
<tr>
<td style="color: black; background-color:lightgrey;"><?php echo $row->ename;?></td>
<td style="color: black; background-color:lightgrey;"><?php echo $row->jobtitle;?></td>
<td style="color: black; background-color:lightgrey;"><?php echo $row->jsname;?></td>
<td style="color: black; background-color:lightgrey;"><?php echo $row->phonenumber;?></td>
<td style="color: black; background-color:lightgrey;"><?php echo $row->email;?></td>
<td style="color: black; background-color:lightgrey;"><?php echo $row->gender;?></td>
<td style="color: black; background-color:lightgrey;"><?php echo $row->education;?></td>
<td style="color: black; background-color:lightgrey;"><?php echo $row->fieldstudy;?></td>
<td style="color: black; background-color:lightgrey;"><?php echo $row->school;?></td>
<td style="color: black; background-color:lightgrey;"><?php echo $row->skills;?></td>
<td style="color: black; background-color:lightgrey;"><?php echo $row->cv_coverletter;?></td>
</tr>
<?php  } ?>
</table>
</div>
