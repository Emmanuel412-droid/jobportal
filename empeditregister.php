...
include("database.php");
    if(ISSET($_POST['edit'])){
      ...
      $sql = "UPDATE empregister SET ename = '$ename',empid='$empid',phonenumber = '$phonenumber',email='$email',county='$county' WHERE empid='$empid'";
      $result= mysqli_query($conn, $sql);
        if($result){
            $subject = "Account Details Edited";
            $message = "You have edited your account details successfully.Your new phonenumber will be $phonenumber, email will be $email and county will be $county.";
            $sender = "From: cheruiyotemmanuel24@gmail.com";
            if(mail($email, $subject, $message, $sender)){
                $_SESSION['email'] = $email;
                echo("<script language='javascript'>window.alert('Details edited successfully!');window.location='empaccountdetails.php';</script>");
                
            }else{
                echo("<script language='javascript'>window.alert('Edit unsuccessful!');window.location='empaccountdetails.php';</script>");
            }
        }else{
            echo("<script language='javascript'>window.alert('Failed while inserting data into database!');window.location='empaccountdetails.php';</script>");
        }
    }
...
ul {
    ...
    ul li {
        ...
        function validateForm() {
            ...
            if (ename == ""  || empid=="" || phonenumber=="" || email=="" || county=="" ) {
...
<div class="section">
<div class="sect">
    <form id="register" action="empeditregister.php" method="post" onsubmit="return validateForm()">
        <fieldset style="width:900px; background-color: floralwhite;">
            ...
            <input style="height:50px; width:600px; border: 1px hidden; background-color: lightgrey; color: black; font-size: 26px;" width="40px" id="ename" type="text" name="ename" onselectstart="return false" oncut="return false" oncopy="return false" onpaste="return false" ondrag="return false" ondrop="return false" required="">

            <h2><label class="required">Employer ID</label></h2>
            <p style="color: red;"><big>Employer ID should be same as original one</big></p>
            <input style="height:50px; width:600px; border: 1px hidden; background-color: lightgrey; color: black; font-size: 26px;" width="40px" id="empid" type="text" name="empid" onselectstart="return false" oncut="return false" oncopy="return false" onpaste="return false" ondrag="return false" ondrop="return false" required="">
            ...
            <input style="height:50px; width:300px; border: 1px hidden; background-color: black; color: floralwhite; font-size: 26px;" id="edit" type="submit"  name="edit" value="EDIT" onclick="validateForm()">
