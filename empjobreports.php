...
<div class="nav">
        <ul>
            <li class="active"><a href="empapplicationsreports.php">APPLICATION REPORTS</a></li>
...
<table style="width:1800px;" id="myTable">
                    <tr>
                        ...
                        <th style="height: 20px; color: blue; background-color: lightgreen;">Town</th>
                    </tr>
                    <tbody style="font-size:28px;" id="geekss">
                    
                        <?php
                            include_once('database.php');
                            $sql = "SELECT * FROM postjob where ename= ?";
