...
<div class="sidenav">
    ...
    <a class="active" style="text-decoration: none; font-size: 22px;" href="empmanagejobs.php">MANAGE JOBS</a><br>
...
<div class="section">
<table style="width:1650px; padding-top:50px;" border="1">
...
include("database.php");
    ...
    $ret = "SELECT * FROM postjob WHERE ename=? AND status=5";
...
<td style="color: black; background-color:lightgrey;"><button><a style=" font-size:28px; text-decoration: none;" href="empeditjobs.php?jobuserid=<?php echo $row->jobuserid;?>"><big>Edit</big></a></button><br><br><button><a style="font-size: 28px; text-decoration: none;" href="empdeletejobs.php?jobuserid=<?php echo $row->jobuserid;?>"><big>Delete</big></a></button></td>
</tr>
<?php  } ?>
</table>
</div>
