...
//if user click check reset otp button
    if(isset($_POST['verify'])){
        ...
        $check_code = "SELECT * FROM empregister WHERE regcode = $otp_code";
        ...
        if(mysqli_num_rows($code_res) > 0){
            ...
            $_SESSION['info'] = $info;
            echo("<script language='javascript'>window.alert('Verified.Add profile!');window.location='empaddprofile.php';</script>");
            // header('location: empaddprofile.php');
            exit();
        }else{
...
<body>
    <div class="section">
                <form action="empregverify.php" method="POST">
