...
<div class="sidenav">
    ...
    <h3>SETTINGS</h3>
    <a class="active" style="text-decoration: none; font-size: 22px;" href="empreports.php"><span>REPORTS</span></a><br>
...
<div class="box-container9">
                <div class="box box9 ">
                    <div class="text">
                        <img style="width: 100px; height: 100px; margin-top: -30px; margin-left: 55px;" src="images/jobs.jpg">
                        <button style="width:150px; height:80px; margin-top: 20px; margin-left: 30px; background-color:white;"><a style="text-decoration:none; color: black;" href="empapplicationsreports.php"><h2>APPLICATION REPORTS</h2></a></button>
                    </div>
                </div>
                <div class="box box9 ">
                    <div class="text">
                        <img style="width: 100px; height: 100px; margin-top: -30px; margin-left: 55px;" src="images/jobs.jpg">
                        <button style="width:150px; height:80px; margin-top: 20px; margin-left: 30px; background-color:white;"><a style="text-decoration:none; color: black;" href="empjobreports.php"><h2>JOBS REPORTS</h2></a></button>
