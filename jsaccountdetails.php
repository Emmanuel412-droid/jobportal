...
<div class="sidenav">
    ...
    <a class="active" style="text-decoration: none; font-size: 22px;" href="jsaccountdetails.php"><span>ACCOUNT DETAILS</span></a><br>
    <h3>EXIT</h3>
...
include("database.php");
    ...
    $ret = "SELECT * FROM jsregister WHERE jsname=?";
...
?>
<tr>
<td style="height:150px; color: black; background-color:lightgrey; font-size: 28px;"><?php echo $row->jsname;?></td>
<td style="height:150px; color: black; background-color:lightgrey; font-size: 28px;"><?php echo $row->jsid;?></td>
...
<td style="height:150px; color: black; background-color:lightgrey;"><button style="width: 80px; "><a style=" font-size: 28px;text-decoration: none;" href="jseditregister.php?jsid=<?php echo $row->jsid;?>"><big>Edit</big></a></button></td>
<td style="height:150px; color: black; background-color:lightgrey;"><button style="width: 120px; "><a style=" font-size: 28px;text-decoration: none;" href="jsdeleteaccount.php?jsid=<?php echo $row->jsid;?>"><big>Delete</big></a></button></td>
</tr>
<?php } ?>
</table>
</div>
