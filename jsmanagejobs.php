...
<div class="sidenav">
    ...
    <a class="active" style="text-decoration: none; font-size: 22px;" href="jsmanagejobs.php"><span>MANAGE JOBS</span></a><br>
...
<td style="width: 350px;  color: black; background-color:lightgrey; font-size: 28px"><?php echo $row->jobdescription;?></td>
<td style="color: black; background-color:lightgrey; font-size: 28px"><?php echo $row->deadline;?></td>
<td style="color: black; background-color:lightgrey;"><button style="width: 95px; height:50px;"><a style="font-size: 28px; text-decoration:none; color:blue;" href="jsapplyjobs.php?jobuserid=<?php echo $row->jobuserid;?>"><big>Apply</big></a></button></td>
</tr>
<?php  } ?>
</tbody>
</table>
