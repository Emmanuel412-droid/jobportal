      ...
      $stmt = "SELECT * FROM jsregister WHERE email='$email'";
        ...
        if($result){
            ...
            if(mail($email, $subject, $message, $sender)){
                ...
                echo("<script language='javascript'>window.alert('Code sent to email.Registration successfully!');window.location='jsregverify.php';</script>");
                // header('location: jsregverify.php');
                exit();
            }else{
...
<div class="section">
<div class="sect">
    <form id="register" action="jsregister.php" method="post" onsubmit="return validateForm()">
        <fieldset style="width:900px; background-color: floralwhite;">
            ...
            <input style="height:50px; width:600px; border: 1px hidden; background-color: lightgrey; color: black; font-size: 26px;" id="password" type="password" name="password" onselectstart="return false" oncut="return false" oncopy="return false" onpaste="return false" ondrag="return false" ondrop="return false" required><br>
            ...
            <input style="height:50px; width:600px; border: 1px hidden; background-color: lightgrey; color: black; font-size: 26px;" width="40px" id="conpassword" type="password" name="conpassword" onselectstart="return false" oncut="return false" oncopy="return false" onpaste="return false" ondrag="return false" ondrop="return false" required><br>
            ...
            <input style="height:50px; width:300px; border: 1px hidden; background-color: black; color: floralwhite; font-size: 26px;" id="register" type="submit"  name="register" value="REGISTER" onclick="validateForm()">
