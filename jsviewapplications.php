...
<div class="sidenav">
    ...
    <a class="active" style="text-decoration: none; font-size: 22px;" href="jsviewapplications.php"><span>VIEW APPLICATIONS</span></a><br>
...
<td><b>School</b></td>
<td style="width:500px;"><b>Skills</b></td>
...
include("database.php");
    ...
    $ret = "SELECT * FROM jobapplication WHERE jsname=?";
...
<td style="color: black; background-color:lightgrey; font-size: 28px;"><?php echo $row->appid;?></td>
...
<td style="color: black; background-color:lightgrey; font-size: 28px;"><?php echo $row->fieldstudy;?></td>
<td style="color: black; background-color:lightgrey; font-size: 28px;"><?php echo $row->school;?></td>
<td style="color: black; background-color:lightgrey; font-size: 28px;"><?php echo $row->skills;?></td>
<td style="color: black; background-color:lightgrey; font-size: 28px;"><?php echo $row->cv_coverletter;?></td>
<!--<td style="color: black; background-color:lightgrey; font-size: 25px"><button style="width:90px; height:50px;"><a style="text-decoration:none; color: blue;" href="jseditapplications.php?appid=<?php echo $row->appid;?>"><h2>Edit</h2></button></a></td>-->
<td style="color: black; background-color:lightgrey;"><button><a style="width: 50px; height: 30px; text-decoration: none; margin-top: 20px; font-size: 28px;" style="text-decoration: none;"href="jsdeleteapplications.php?appid=<?php echo $row->appid;?>">Delete</a></button></td>
</tr>
<?php  } ?>
</table>
