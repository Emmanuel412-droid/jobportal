...
if(isset($_POST['approve'])){
    ...
    $sql="UPDATE empregister SET status = '$status' WHERE empid = '$name'";

    $result = mysqli_query($conn, $sql);
    if($result){
            
                echo("<script language='javascript'>window.alert('Approved Successfully!');window.location='superemployers.php';</script>");
                

                
                exit();
            }else{
                echo("<script language='javascript'>window.alert('Not approved!');window.location='superemployers.php';</script>");
...
if(isset($_POST['reject'])){
    ...
    $result = mysqli_query($conn, $sql);
    if($result){
            echo("<script language='javascript'>window.alert('Rejected Successfully!');window.location='superemployers.php';</script>");
                
                exit();
            }else{
                echo("<script language='javascript'>window.alert('Not rejected!');window.location='superemployers.php';</script>");
            }
        }
...
<div class="sidenav">
        ...
        <h3>USERS</h3>
        <a class="active" style="text-decoration: none; font-size: 22px;" href="superemployers.php"><span>EMPLOYERS</span></a><br>
...
<div class="section">
    ...
    <div class="dissect">
       <button style="width: 300px; height:50px; background-color: black; margin-top:20px;"><a style="text-decoration:none; color:white;" href="superaddemployers.php"><h2>Add New Employer</h2></a></button>
    </div>
  </div>
    
<table style="width:1650px; margin-top:20px;" id="myTable">
<tr>
...
<td style="color: black; background-color:lightgrey; font-size: 28px"><?php echo $row->empid;?></td>
...
<form action="" method="post">
    ...
    <input type="hidden" name="name" value="<?php echo $row->empid;?>" >
...
<td style="color: black; background-color:lightgrey;"><button><a style="width: 90px; height: 50px; text-decoration: none; margin-top: 20px; font-size: 25px;" style="text-decoration: none;"href="superdeleteemployers.php?empid=<?php echo $row->empid;?>">Delete</a></button></td>
</tr>
<?php } ?>
</tbody>
</table>
