...
<body>
 <div class  ="header">
    <h1>Jobseeker Reports</h1>
</div>
<div class="nav">
        <ul>
            <li class="active"><a href="superemployerreports.php">EMPLOYERS REPORTS</a></li>
            <li class="active"><a href="superjobreports.php">JOBS REPORTS</a></li>
...
<div  style="padding-top: 20px;" class="section">
  <div class="sector">
    <div class="dissect">
        <input style="width: 500px; height: 30px; border: 3px solid black; font-size: 28px;" id="myInput" onkeyup="myFunction()" type="text" placeholder="Search according to jobseeker name">
    </div>
    <!--<div class="dissect">
...
<table style="width:1800px;" id="myTable">
                    <tr>
                        ...
                        <th style="height: 20px; color: blue; background-color: lightgreen;">County</th>
                    </tr>
                    <tbody style="font-size: 28px;" id="geekss">
                    
                        <?php
                            include_once('database.php');
                            $sql = "SELECT * FROM jsregister";
