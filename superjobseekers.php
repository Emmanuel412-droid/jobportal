...
if(isset($_POST['approve'])){
    ...
    $sql="UPDATE jsregister SET status = '$status' WHERE jsid = '$name'";

    $result = mysqli_query($conn, $sql);
    if($result){
            echo("<script language='javascript'>window.alert('Approved Successfully!');window.location='superjobseekers.php';</script>");
                
                exit();
            }else{
                echo("<script language='javascript'>window.alert('Not approved!');window.location='superjobseekers.php';</script>");
            }
...
if(isset($_POST['reject'])){
    ...
    if($result){
                ...
                echo("<script language='javascript'>window.alert('Rejected Successfully!');window.location='superjobseekers.php';</script>");
                
                exit();
            }else{
                echo("<script language='javascript'>window.alert('Not rejected!');window.location='superjobseekers.php';</script>");
            }
        }
...
<div class="sidenav">
        ...
        <a class="active" style="text-decoration: none; font-size: 22px;" href="superjobseekers.php"><span>JOBSEEKERS</span></a><br>
...
<div class="section">
    ...
    <div class="dissect">
       <button style="width: 300px; height:50px; background-color: black; margin-top:20px;"><a style="text-decoration:none; color:white;" href="superaddjobseekers.php"><h2>Add New Jobseeker</h2></a></button>
    </div>
  </div>
<table style="width:1650px; margin-top:20px;" border="1" id="myTable">
<tr>
...
<td style="color: black; background-color:lightgrey; font-size: 28px"><?php echo $row->jsid;?></td>
...
<td style="color: black; background-color:lightgrey;">
<?php
$stat=$row->status;
if($stat<4){
    ?>
<form action="" method="post">
    ...
    <input type="hidden" name="name" value="<?php echo $row->jsid;?>" >
...
<td style="color: black; background-color:lightgrey;"><button><a style="width: 90px; height: 50px; text-decoration: none; margin-top: 20px; font-size: 28px;" style="text-decoration: none;"href="superdeletejobseekers.php?jsid=<?php echo $row->jsid;?>">Delete</a></button></td>
</tr>
<?php } ?>
</tbody>
</table>
