...
<div class="sidenav">
        ...
        <a class="active" style="text-decoration: none; font-size: 22px;" href="superprofile.php"><span>PROFILE</span></a><br>
        <h3>SETTINGS</h3>
...
<div class="section">
<table style="width: 1600px; padding-top: 300px;">
...
include("database.php");
    $ret = "SELECT * FROM superprofile WHERE aname=?";
...
?>
<tr>
<td style="height:190px; color: black; background-color:lightgrey; font-size: 28px;"><?php echo $row->aname;?></td>
<td style="height:190px; color: black; background-color:lightgrey; font-size: 28px;"><?php echo $row->phonenumber;?></td>
<td style="height:190px; color: black; background-color:lightgrey; font-size: 28px;"><?php echo $row->email;?></td>
<td style="height:190px; color: black; background-color:lightgrey; font-size: 28px;"><?php echo $row->gender;?></td>
<td style="height:190px; color: black; background-color:lightgrey; font-size: 28px;"><?php echo $row->county;?></td>
<td style="height:190px; color: black; background-color:lightgrey; font-size: 28px;"><?php echo $row->town;?></td>
<td style="height:190px; color: black; background-color:lightgrey; font-size: 28px;"><?php echo $row->id_passport;?></td>
<td style="height:190px; color: black; background-color:lightgrey; font-size: 28px;"><?php echo $row->dob;?></td>
<td style="height:190px; color: black; background-color:lightgrey; font-size: 28px;"><?php echo $row->postal;?></td>
<td style="height:190px; color: black; background-color:lightgrey; font-size: 28px;"><?php echo $row->zip;?></td>
<td style="color: black; background-color:lightgrey;"><button style="width:70px;"><a style="font-size: 28px; text-decoration: none;"href="supereditprofile.php?aname=<?php echo $row->aname;?>"><big>Edit</big></a></button></td>
</tr>
<?php  } ?>
</table>
</div>
