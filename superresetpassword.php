...
include("database.php");
 ...
 if(isset($_POST['change'])){
        ...
        if($password !== $conpassword){
            ...
            $update_pass = "UPDATE superadmin SET code = $code, password = md5('$password') WHERE email = '$email'";
            $run_query = mysqli_query($conn, $update_pass);
            if($run_query){
                $info = "Your password changed. Now you can login with your new password.";
                $_SESSION['info'] = $info;
                echo("<script language='javascript'>window.alert('Password changed successfully!');window.location='login.php';</script>");
             // header('Location: jslogin.php');
            }else{
                echo("<script language='javascript'>window.alert('Failed to change your password!');window.location='superresetpassword.php';</script>");
...
<div class="section">
        <form method="POST" action="superresetpassword.php" id="changepassword" name="changepassword" onsubmit="return validateForm()">
          <fieldset style="width:900px; background-color:floralwhite;">
            ...
            <input style="width:15px; height:15px;" type="checkbox" onclick="showNewPassword()">Show New Password
            ...
            <input style="width:15px; height:15px;" type="checkbox" onclick="showConfirmNewPassword()">Show Confirm New Password<br><br><br>
